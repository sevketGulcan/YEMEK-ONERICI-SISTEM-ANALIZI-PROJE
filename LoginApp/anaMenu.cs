...
namespace LoginApp
{
    public partial class anaMenu : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            int toplam1 = checkedListBox2.Items.Count;
            for (int i = 0; i < toplam1; i++)
            {
                checkedListBox2.SetItemChecked(i, false);
            }
            int toplam2 = checkedListBox3.Items.Count;
            for (int i = 0; i < toplam2; i++)
            {
                checkedListBox3.SetItemChecked(i, false);
            }
            int toplam3 = checkedListBox4.Items.Count;
            for (int i = 0; i < toplam3; i++)
            {
                checkedListBox4.SetItemChecked(i, false);
            }
            int toplam4 = checkedListBox5.Items.Count;
            for (int i = 0; i < toplam4; i++)
            {
                checkedListBox5.SetItemChecked(i, false);
            }
            int toplam5 = checkedListBox6.Items.Count;
            for (int i = 0; i < toplam5; i++)
            {
